...
function Card1() {
  ...
  return (
    ...
    >
      <Card style={{borderColor:'white' , borderRadius:"8px"}}
      className={styles.children} as={Link} to="ir" onClick={dispatch(ActionRefresh(true))} >
        <Card.Body>
      ...
      <Card className={styles.children} as={Link} to="ir2" style={{borderColor:'white' , borderRadius:"8px"}}>
        ...
        variant="top" src={require("./images/2.jpg")} />
      </Card>
      <Card className={styles.children} as={Link} to="ir" style={{borderColor:'white' , borderRadius:"8px"}}>
        <Card.Body>
        ...
        variant="top" src={require("./images/3.png")} />
      </Card>
    </CardGroup>
  );
}
